...
#Install PHP
RUN apt-get install php7.2 php7.2-cli php7.2-common php7.2-cgi php7.2-zip php7.2-curl php7.2-imap php7.2-pgsql php7.2-sqlite3 php7.2-mysql php7.2-fpm php7.2-intl php7.2-gd php7.2-json php7.2-ldap php-memcached php-memcache php-imagick php7.2-xml php7.2-mbstring -y
