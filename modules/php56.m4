...
# Install PHP
RUN apt-get install php5.6-cli php5.6-common php5.6-cgi php5.6-curl php5.6-zip php5.6-imagick php5.6-imap php5.6-pgsql php5.6-sqlite php5.6-mysql php5.6-fpm php5.6-mcrypt php5.6-ldap php5.6-json php5.6-intl php5.6-gd php5.6-xml php5.6-mbstring php5.6-dom -y
