...
# Install PHP
RUN apt-get install php7.3 php7.3-cli php7.3-common php7.3-cgi php7.3-curl php7.3-imap php7.3-pgsql php7.3-sqlite3 php7.3-mysql php7.3-fpm php7.3-intl php7.3-gd php7.3-json php7.3-ldap php-memcached php-memcache php-imagick php7.3-xml php7.3-mbstring -y
