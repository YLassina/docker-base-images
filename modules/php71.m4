...
#Install PHP
RUN apt-get install php7.1 php7.1-cli php7.1-common php7.1-cgi php7.1-zip php7.1-curl php7.1-imap php7.1-pgsql php7.1-sqlite3 php7.1-mysql php7.1-fpm php7.1-intl php7.1-gd php7.1-json php7.1-ldap php-memcached php-memcache php-imagick php7.1-xml php7.1-mbstring -y
