...
In this image is a basic nginx webserver with PHP 7.3 installation available. It is configured to run a Symfony 4 application placed in /var/www. There are no SSL enabled per default.
